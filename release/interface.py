...
class Interface(Api, File_System):
    ...
    def checkInputs(self):
        # r'(?:3[01]|[12][0-9]|0?[1-9])([/])(0?[1-9]|1[0-2])\1\d{4}'
        REDate = r'(?:(?:(?:0?[1-9]|1\d|2[0-8])[/](?:0?[1-9]|1[0-2])|(?:29|30)[/](?:0?[13-9]|1[0-2])|31[/](?:0?[13578]|1[02]))[/](?:0{2,3}[1-9]|0{1,2}[1-9]\d|0?[1-9]\d{3}|[1-9]\d{3})|29[/]0?2[/](?:\d{1,2}(?:0[48]|[2468][048]|[13579][26])|(?:0?[48]|[13579][26]|[2468][048])00)|(2019))'
        checkDate = 0
        self.flag = 0
